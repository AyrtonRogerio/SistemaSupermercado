...
public class SQLUtil {
	...
	public static class Endereco {
		...
		public static final String INSERT = "insert into " + NOME_TABELA + "(" + COL_RUA + "," + COL_CEP + ","
				+ COL_NUMERO + "," + COL_BAIRRO + "," + COL_CIDADE + "," + COL_ESTADO
				+ " ) values (?,?,?,?,?,?) returning id";
	...
	public static class Contato {
		...
		public static final String INSERT = "insert into " + NOME_TABELA + "(" + COL_TIPO + "," + COL_DESCRICAO + ","
	...
	public static class Cliente {
		...
		public static final String INSERT = "insert into " + NOME_TABELA + "(" + COL_NOME + "," + COL_CPF + ","
				+ COL_SEXO + "," + COL_ESTADO_CIVIL + "," + COL_OCUPACAO + "," + COL_DATA_NASCIMENTO + ","

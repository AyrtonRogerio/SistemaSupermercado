...
public class BusinessContas_a_Receber implements  IBusinessContas_a_Receber {
	...
	/* (non-Javadoc)
	 * @see br.com.sistemasupermercado.business.IBusinessContas_a_Receber#getAll_Recebida()
	 */
	@Override
	public List<Contas_a_Receber_Adapter> getAll_Recebida() throws BusinessException {
		try {
            return daoContas_a_receber.getAll_Recebida();
        } catch (DaoException e) {
            e.printStackTrace();
            throw new BusinessException(e.getMessage());
        }
	...
	/* (non-Javadoc)
	 * @see br.com.sistemasupermercado.business.IBusinessContas_a_Receber#getAll_A_Receber()
	 */
	@Override
	public List<Contas_a_Receber_Adapter> getAll_A_Receber() throws BusinessException {
		try {
            return daoContas_a_receber.getAll_A_Receber();
        } catch (DaoException e) {
            e.printStackTrace();
            throw new BusinessException(e.getMessage());
        }

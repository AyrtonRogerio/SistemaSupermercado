 ...
 *
 */
public class Relatorio_Contas_Receber {
	...
	public static void main(String[] args) {
		...
		try {
			contas_a_Receber_Adapters = Fachada.getInstance().getAll_A_ReceberConta_a_Receber();
			new Documentos().gerarDocumento(contas_a_Receber_Adapters, "Contas_a_receber.jrxml");
